...
class BertForCrossEntityAlignment(BertPreTrainedModel):
    def __init__(self, config):
        super(BertForCrossEntityAlignment, self).__init__(config)
    ...
    def forward(
        ...
        sequence_output = outputs[0]
        entity1 = sequence_output[1:len_entity1+1]
        entity2 = sequence_output[len_entity1+2:]
        T, C = ipot(entity1, entity2)
        loss_cea = torch.mean(torch.mul(T,C))
