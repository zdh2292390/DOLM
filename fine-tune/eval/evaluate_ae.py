...
#     elif 'Laptops' in command:
    ...
    # acc=check_output(command,shell=True ).split()
...
#     elif 'laptop' in args.pred_json:
    command="java -cp ./eval/eval.jar Main.Aspects ./data/ae/official_data/laptop_pred.xml ./data/ae/official_data/Laptops_Test_Gold.xml"
    template="./data/ae/official_data/Laptops_Test_Data_PhaseA.xml"
